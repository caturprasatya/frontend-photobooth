...
const Frame = (props) => {
  ...
  const confirmButton = () =>
    Swal.fire({
      ...
      confirmButtonColor: "#D63030",
      confirmButtonText:
        '   <strong style="padding: 10px 50px;">OK</strong>    ',
    }).then((result) => {
  ...
  const [frameSelected, setFrameSelected] = useState(null);
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <button className="btn bg-transparent" onClick={validatationFrame}>
          <img
            src={cameraIcon}
            style={{ height: "8vh", marginTop: "20px" }}
            alt="camera-icon"
          />
        </button>
